...
const Header = (props: HeaderProps) => {
  ...
  const displayMonthAndYear = () => {
    if (month.containsTwoMonths && !year.containsTwoYears) {
      return (
        <>
          {month.prevMonth} - {month.nextMonth} {year.currYear}
        </>
      );
    } else if (month.containsTwoMonths && year.containsTwoYears) {
      return (
        <>
          {month.prevMonth} {year.prevYear} - {month.nextMonth} {year.nextYear}
        </>
      );
    }
    return (
  ...
  return (
    <HeaderWrapper id="header-wrapper">
      ...
      <MonthAndYearTextWrapper id="month-and-year-text-wrapper">
        <MonthAndYearText>{displayMonthAndYear()}</MonthAndYearText>
      </MonthAndYearTextWrapper>
    </HeaderWrapper>
  );
};
